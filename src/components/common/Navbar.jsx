              ...
              <li key={index}>
                {link.title === "Catalog" ? (
                  <div className="relative flex cursor-pointer items-center gap-2 group">
                    ...
                    <div
                      className=" invisible absolute left-[50%] top-[50%] z-[1000] w-[200px] translate-x-[-50%] translate-y-[3rem]
                        ...
                        {subLinks?.length ? (
                          subLinks?.map((subLink, index) => (
                            <Link
                              ...
                              key={index}
                            >
                              <p className=" hover:bg-richblack-50 bg-transparent rounded-lg py-4 px-4 font-semibold">
                                {subLink?.name}
                              </p>
                            </Link>
                          ))
                        ) : (
                          <div className="text-richblack-900 text-center">
                            No data found
                          </div>
                        )}
                      </div>
